    ...
    publications {
        register<MavenPublication>("maven") {
            ...
            pom {
                ...
                url.set("https://www.github.com/stainless-sdks/dataleonlabs-kotlin")
                ...
                scm {
                    connection.set("scm:git:git://github.com/stainless-sdks/dataleonlabs-kotlin.git")
                    developerConnection.set("scm:git:git://github.com/stainless-sdks/dataleonlabs-kotlin.git")
                    url.set("https://github.com/stainless-sdks/dataleonlabs-kotlin")
                }
