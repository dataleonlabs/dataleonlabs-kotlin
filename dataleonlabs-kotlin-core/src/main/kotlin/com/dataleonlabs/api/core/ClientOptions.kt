...
package com.dataleonlabs.api.core

import com.dataleonlabs.api.core.http.Headers
import com.dataleonlabs.api.core.http.HttpClient
import com.dataleonlabs.api.core.http.PhantomReachableClosingHttpClient
import com.dataleonlabs.api.core.http.QueryParams
import com.dataleonlabs.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `dataleonlabs-kotlin-client-okhttp` or implement your own.
     *
    ...
    class Builder internal constructor() {
         ...
         */
        fun fromEnv() = apply {
            (System.getProperty("dataleonlabs.baseUrl") ?: System.getenv("DATALEONLABS_BASE_URL"))
                ?.let { baseUrl(it) }
            (System.getProperty("dataleonlabs.apiKey") ?: System.getenv("DATALEONLABS_API_KEY"))
                ?.let { apiKey(it) }
        }
