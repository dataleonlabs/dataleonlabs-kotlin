...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.dataleonlabs.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.dataleonlabs.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.dataleonlabs.api.** {
    <init>(...);
