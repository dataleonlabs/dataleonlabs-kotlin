...
package com.dataleonlabs.api.client.okhttp

import com.dataleonlabs.api.client.DataleonlabsClientAsync
import com.dataleonlabs.api.client.DataleonlabsClientAsyncImpl
import com.dataleonlabs.api.core.ClientOptions
import com.dataleonlabs.api.core.Sleeper
import com.dataleonlabs.api.core.Timeout
import com.dataleonlabs.api.core.http.Headers
import com.dataleonlabs.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [DataleonlabsClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class DataleonlabsOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [DataleonlabsClientAsync]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): DataleonlabsClientAsync = builder().fromEnv().build()
    }

    /** A builder for [DataleonlabsOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.dataleonlabs.api.core.jsonMapper]. The default is usually sufficient and
        ...
        /**
         * Returns an immutable instance of [DataleonlabsClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DataleonlabsClientAsync =
            DataleonlabsClientAsyncImpl(
                clientOptions
                    .httpClient(
