...
import com.dataleonlabs.api.core.http.HttpRequestBody
import com.dataleonlabs.api.core.http.HttpResponse
import com.dataleonlabs.api.errors.DataleonlabsIoException
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw DataleonlabsIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("DATALEONLABS_LOG")?.lowercase()) {
