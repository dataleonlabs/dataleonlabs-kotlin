...
import com.dataleonlabs.api.client.DataleonlabsClientImpl
...
/**
 * A class that allows building an instance of [DataleonlabsClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class DataleonlabsOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [DataleonlabsClient]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): DataleonlabsClient = builder().fromEnv().build()
    }

    /** A builder for [DataleonlabsOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [DataleonlabsClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DataleonlabsClient =
            DataleonlabsClientImpl(
                clientOptions
                    .httpClient(
