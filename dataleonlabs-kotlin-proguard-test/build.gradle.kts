...
dependencies {
    testImplementation(project(":dataleonlabs-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../dataleonlabs-kotlin-core/src/main/resources/META-INF/proguard/dataleonlabs-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.dataleonlabs.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../dataleonlabs-kotlin-core/src/main/resources/META-INF/proguard/dataleonlabs-kotlin-core.pro",
